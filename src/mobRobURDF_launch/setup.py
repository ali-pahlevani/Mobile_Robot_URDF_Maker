...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/launch', ['launch/urdf_gazebo_test.launch.py']),
        ('share/' + package_name + '/launch/slam_launch', ['launch/slam_launch/online_async_mapper_launch.py']),
        ('share/' + package_name + '/launch/slam_launch', ['launch/slam_launch/online_async_localizer_launch.py']),
        ('share/' + package_name + '/launch/nav_launch', ['launch/nav_launch/localization_launch.py']),
        ('share/' + package_name + '/launch/nav_launch', ['launch/nav_launch/navigation_launch.py']),
